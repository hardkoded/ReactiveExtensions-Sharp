...
public class Subject<T> : IObservable<T>, IObserver<T>, IDisposable
{
    ...
    /// <see cref="OnCompleted"/>. Exposed to subclasses (see <see cref="ReactiveExtensionsSharp.Subjects.ReplaySubject{T}"/>) so they
    ...
    /// subclasses (see <see cref="ReactiveExtensionsSharp.Subjects.BehaviorSubject{T}"/>, <see cref="ReactiveExtensionsSharp.Subjects.AsyncSubject{T}"/>)
