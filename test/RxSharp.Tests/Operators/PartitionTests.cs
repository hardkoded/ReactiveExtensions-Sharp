...
// marble/expectSubscriptions assertions (no subscription-log helper exists yet in RxSharp.Testing), using
...
public class PartitionTests
{
    ...
    // exactly two independent subscriptions, one per returned observable. RxSharp.Testing has no
